 ...
 * @author bradtaylor
 */
public class SamRecordTrackingBuffer<T extends SamRecordIndex> {
    ...
    private class BufferBlock {
        ...
        private int ensureIndexFitsInAnInt(final long value) {
            if (value < Integer.MIN_VALUE || Integer.MAX_VALUE < value) throw new SAMException("Warning: index out of range: " + value);
            return (int)value;
        }
        ...
        public void setExamined(final SamRecordIndex samRecordIndex, final boolean examinedState) {
            ...
            this.wasExaminedIndexes.set(ensureIndexFitsInAnInt(samRecordIndex.getRecordIndex() - this.originalStartIndex), true);
            this.examinedStateIndexes.set(ensureIndexFitsInAnInt(samRecordIndex.getRecordIndex() - this.originalStartIndex), examinedState);
        }
        ...
        public SamRecordIndex next() throws IllegalStateException {
            if (this.canEmit()) {
                try {
                    ...
                    samRecordIndex.setExaminedState(this.examinedStateIndexes.get(ensureIndexFitsInAnInt(this.currentStartIndex - this.originalStartIndex)));
